// ============================================================
// VOSIL — Widget Renderer for Structured JSON Responses
// ============================================================
    ...
    function renderWeatherAnalysis(data) {
        ...
        return `
            <div class="oxy-widget wx-analysis-widget">
                ...
                <div class="wx-footer">
                    <i class="fa-regular fa-clock"></i>
                    <span>Weather analysis · VOSIL</span>
                </div>
            </div>
        `;
    }
    ...
    function renderAnalysisCard(data) {
        ...
        return `
            <div class="oxy-widget ac-widget" style="--accent: ${color};">
                ...
                <div class="wx-footer">
                    <i class="fa-regular fa-clock"></i>
                    <span>Analysis report · VOSIL</span>
                </div>
            </div>
        `;
    }
        ...
        return `
            <div class="oxy-widget ic-widget" style="--accent: ${color};">
                ...
                <div class="wx-footer">
                    ...
                    <span>Information card · VOSIL</span>
                </div>
            </div>
        `;
    }
        ...
        return `
            <div class="oxy-widget cd-widget" style="--accent: ${color};">
                ...
                <div class="wx-footer">
                    ...
                    <span>Data visualization · VOSIL</span>
                </div>
            </div>
        `;
    }
